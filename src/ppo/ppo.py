...
class PPOActor(Actor):
    ...
    def act(self, phase, params):
        ...
        if phase == 2:
            ...
            return reward, new_state, action, miu, sigma, done
        if phase == 3:
...
class PPOLearner(Learner):
    ...
    def learn(self, experience):
        ...
        def discounted_reward(rewards, v_last, gamma):
            ...
            rewards = rewards.reshape(1000, -1)
        ...
        def gae(reward_list,
            ...
            delta = self.squeeze(reward_list + gamma * next_critic_value -
                                 critic_value)
            delta = self.reshape(delta, (1000, -1))
